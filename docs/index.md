---
page_title: "support-v1alpha1 Provider"
---

# support-v1alpha1 Provider

This provider is used to interact with the resources provided by the **support-v1alpha1** application of the [Nokia EDA](https://docs.eda.dev) platform.
