...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-support/internal/datasource_workflow_get_inputs_resp_elem"
...
const read_ds_workflowGetInputsRespElem = "/workflows/v1/support.eda.nokia.com/v1alpha1/namespaces/{namespace}/locators/{name}/_input"
