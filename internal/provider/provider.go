...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-support/internal/eda/utils"
...
var _ provider.Provider = (*supportProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &supportProvider{version: ver}
	}
}
...
func (p *supportProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *supportProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *supportProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "support-v1alpha1"
	resp.Version = p.version
}

func (p *supportProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewLocatorDataSource,
		NewLocatorListDataSource,
		NewWorkflowGetInputsRespElemDataSource,
	}
}

func (p *supportProvider) Resources(ctx context.Context) []func() resource.Resource {
